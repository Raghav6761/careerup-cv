...
- מדידת הישגים: במידת האפשר (לא חובה), הוסף מספרים כמותיים להישגים כגון אחוזי שיפור (10-30%), טווחי זמן (2-3 שנים), סכומי חיסכון, מספר אנשים שנוהלו, היקף תקציב. מספרים מגבירים משמעותית את סיכויי הקבלה. אם אין מידע כמותי מפורש, אפשר להעריך טווחים סבירים
- הישגים: עד 2-3 נקודות לכל תפקיד, 4-5 לתפקיד רלוונטי עיקרי. כל נקודה משפט אחד קצר בלבד
- תיאור תפקיד: בנוסף לשם המשרה (title), הוסף גם תיאור תמציתי של התפקיד (1-2 משפטים) המסביר את תחום האחריות העיקרי. אם המועמד העלה תיאור תפקיד מלא, חלץ ממנו מילות מפתח רלוונטיות ושלב אותן בהישגים ובמיומנויות
- סדר הצגת תפקידים: תאריך ראשון, אחריו התפקיד, ורק בסוף שם החברה. לדוגמה: "2011-2013 | מנהלת משאבי אנוש | חברת XYZ". סדר כרונולוגי יורד (מהאחרון לראשון)
...
- חשוב מאוד: אל תשתמש בסוגריים עגולים () או בגרשיים כפולים "" בטקסט העברי. במקום סוגריים השתמש במקף - או בפסיק. במקום גרשיים השתמש בגרש בודד או פשוט השמט אותם{ats_instruction}"""
...
- נסח הישגים מדידים במקום מטלות - לדוגמה: הגדלתי מכירות ב-30% במקום אחראי על מכירות
