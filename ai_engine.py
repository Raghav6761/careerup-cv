...
def _build_consultation_system_prompt(section_key: str) -> str:
    ...
    return (
        ...
        "- אם נכון - השתמש ברשימה קצרה (עד 4-5 פריטים), אחרת כתוב פסקה זורמת.\n"
        "- אל תכתוב עבור המשתמש את התוכן המלא של קורות החיים שלו - תן לו עקרונות, דוגמאות וניסוחים שאותם הוא יכול לאמץ ולהתאים בעצמו.\n"
        "- אם המשתמש מבקש שתכתוב לו במקומו, הסבר בעדינות שאתה כאן לייעץ ושעדיף שהוא יכתוב בעצמו, ותן לו שלד או דוגמה קצרה בלבד.\n"
        "- אל תשאל יותר מדי שאלות בכל תור. אם אתה צריך מידע - שאל שאלה אחת ממוקדת.\n"
