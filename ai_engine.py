...
* תקציר מקצועי: 3-4 משפטים עשירים וחדי-משמעות, המציגים זהות מקצועית ברורה. המשפט הראשון: תואר/תפקיד + שנות ניסיון + טכנולוגיות/מודולים מרכזיים. המשפט השני: תחומי ידע עמוקים ומומחיות ייחודית. המשפט השלישי: ערך עסקי ותרומה לארגון. המשפט הרביעי (אופציונלי): מאפיין אישי בולט כגון ניהול יחסי לקוח, פתרון בעיות, או למידה מהירה. כתוב פסקה רציפה בלי רשימות, בפסקה אחת רציפה.
...
* כלול את כל הניסיון הרלוונטי - אל תשמיט תפקידים או הישגים חשובים.
* תקציר מקצועי: 2-3 משפטים עשירים וחדי-משמעות. המשפט הראשון: תואר/תפקיד + שנות ניסיון + טכנולוגיות/מודולים מרכזיים + תחום עיסוק. המשפט השני: מומחיות מרכזית וערך עסקי. המשפט השלישי (אופציונלי): מאפיין בולט — ניהול לקוחות, פתרון בעיות, למידה מהירה. כתוב פסקה רציפה אחת, ללא רשימות, ללא מיקוף.
...
* מיזוג פרטי קשר: אם טלפון, אימייל, לינקדאין, עיר מגורים או שם מופיעים במספר מקומות שונים במסמך המקורי (למשל גם בראש העמוד וגם בעמודה צדדית), מזג את כולם לסעיף "פרטים אישיים" אחד בלבד בראש המסמך. אל תיצור שני סעיפים נפרדים לפרטי קשר. חובה: כותרת הסעיף הראשון תמיד תהיה בדיוק "פרטים אישיים" — אל תשתמש ב"פרטי קשר", "נתונים אישיים" או כל שם אחר.
