...
2. תקציר מקצועי - 2-3 משפטים בלבד: זהות מקצועית, תחום התמחות, ערך מקצועי מרכזי.
3. ניסיון תעסוקתי - עד 4 תפקידים אחרונים בלבד. לכל תפקיד: שנים → שם חברה → תפקיד → 2-3 נקודות תמציתיות בלבד.
4. שירות צבאי - אם מופיע במקור.
5. השכלה - שנים → מוסד → תואר → תחום לימוד.
6. מיומנויות - עד 8 מיומנויות טכניות ועד 4 מיומנויות רכות.
7. קורסים, הסמכות ופרויקטים - אם מופיעים במקור, עד 3 פריטים.
...
5. השכלה - שנים → מוסד → תואר → תחום לימוד.
6. מיומנויות - עד 8 מיומנויות טכניות ועד 4 מיומנויות רכות.
7. קורסים, הסמכות ופרויקטים - אם מופיעים בנתונים, עד 3 פריטים.
