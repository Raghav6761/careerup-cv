...
* הפרדת שפות: אם שפות מופיעות תחת "שונות", "כישורים נוספים" או כל סעיף שאינו "שפות" — הוצא אותן לסעיף נפרד בשם "שפות" עם רמת השפה לכל שפה. סעיף "שונות" שנותר ריק לאחר הוצאת השפות — הסר אותו.
